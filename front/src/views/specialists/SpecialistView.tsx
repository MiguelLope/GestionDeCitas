...
const SpecialistView = () => {
    ...
    const loadData = async () => {
      try {
        const [especialistaResponse, consultoriosResponse] = await Promise.all([
          axios.get(`${url}especialistas/${idEspecialista}`),
          axios.get(`${url}consultorios`),
        ]);
  ...
  const handleConsultorioSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await axios.put(`${url}especialistas/${especialistaInfo?.id_especialista}/consultorio`, {
  ...
  const handleHorarioSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await axios.put(`${url}especialistas/${especialistaInfo?.id_especialista}/horario`, {
